...
pub fn run_with(paths: &[&str]) {
    ...
    code.push_str("/// Registers `.frb.toml` styles. \n");
    code.push_str("/// This function is automatically @generated by `farben-build`\n");
    code.push_str("///\n");
    code.push_str(
        "/// It includes all styles declared in the `.frb.toml` file ran by `farben-build`'s `run` function \n",
    );
    code.push_str(
        "/// in the form of style registry calls. It is meant to be called, not edited.\n",
    );
