  ...
  return [
    {
      ...
      items: [
        ...
        { text: "Advanced Color Formats", link: "/guide/advanced-colors/" },
        { text: "Inline Syntax", link: "/guide/inline/" },
        { text: "Format Macros", link: "/guide/cformat/" },
        ...
        { text: "Markdown (Deprecated)", link: "/guide/markdown/" },
      ],
    },
    {
      text: "Conventions",
