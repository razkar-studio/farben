...
The latest update, as of writing this is [0.18.1](https://crates.io/crates/farben/0.18.1) and the latest (unreleased, git-only) Alpha being 0.19 Alpha 5, just released after this paper.
