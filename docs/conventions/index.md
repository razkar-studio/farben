...
::: info
Of course, Farben doesn't *care* about idioms. It just cares if your input is correct, even if it's wonky.
Which is why idioms are recommended. Farben can read messy code, sure, but contributors may not. They're not a machine, after all.
:::

Let's explore common dilemmas and idioms for Farben.
